...
\hline
5 & Inv. / Admin. & Confirma la tanda sugerida, o la corrige a mano; elige la sesión (Día 1 o Día 2) y selecciona el archivo \texttt{.mp4}. \\
\hline
6 & Sistema & Valida que el archivo esté en formato \texttt{.mp4} y que sea reproducible. \\
\hline
...
\hline
6 & El archivo no es \texttt{.mp4}: el sistema rechaza la carga con mensaje de error específico antes de iniciar la transmisión (ver RF-08). \\
\hline
