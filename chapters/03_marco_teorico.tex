...
\cite{slattery2012}: tener \textit{validez de constructo} (los mecanismos biológicos
involucrados deben ser parecidos a los del trastorno humano), \textit{validez de cara}
(los síntomas observables deben ser similares a los clínicos) y \textit{validez
...
se graban desde arriba con cámara de celular, capturando los cuatro cilindros al mismo
...
el modelo se necesitan cuadros de video etiquetados por el Dr.\ Salas Ramírez,
