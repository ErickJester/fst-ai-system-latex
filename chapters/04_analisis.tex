...
\begin{longtable}{|>{\bfseries}p{1.1cm}|>{\raggedright}p{2.0cm}|>{\raggedright\arraybackslash}p{6.7cm}|p{1.3cm}|p{1.7cm}|}
...
\begin{longtable}{|>{\bfseries}p{1.1cm}|>{\raggedright}p{1.8cm}|>{\raggedright}p{5.9cm}|>{\raggedright\arraybackslash}p{4.3cm}|}
...
RNF-02 & Calidad del análisis
       & El tiempo de procesamiento no es el criterio prioritario para el laboratorio.
         El criterio de calidad es la concordancia del sistema con el evaluador experto:
         se considera aceptable una concordancia $\geq 85$\,\% por conducta. Este umbral
         fue declarado por el investigador colaborador en la entrevista de levantamiento
         como la variabilidad actual entre analistas humanos (véase la
         justificación de umbrales en la sección~\ref{sec:umbrales}).
       & Concordancia $\geq 85$\,\% entre la clasificación automática y el gold
         standard del laboratorio, medida sobre el conjunto de prueba de la
         fase de validación (TT2). \\
\hline
...
\begin{itemize}
  ...
  \item \textbf{Concordancia mínima con el evaluador experto: $\geq 85$\,\%.}
        Umbral declarado por el investigador colaborador (Dr.\ César Augusto
        Sandino Reyes López) en la entrevista de levantamiento de requerimientos.
        Corresponde a la variabilidad actual entre analistas humanos que anotan
        los mismos videos de forma independiente. El objetivo del sistema es
        igualar o superar ese nivel de consistencia.
...
RN-13 & Si durante la fase de validación el clasificador no alcanza
        $\kappa > 0.80$ distinguiendo las tres conductas por separado,
...
\begin{longtable}{|p{2.3cm}|p{4.8cm}|p{4.8cm}|p{1.3cm}|}
...
\hline
R-08 & El escalamiento y el nado activo se ven tan parecidos desde la vista lateral
