...
RF-07 & Gestión de usuarios
      & Solo el Administrador puede crear cuentas de usuario. No existe formulario
        público de autoregistro. El Administrador asigna nombre, correo institucional
        y contraseña temporal; el sistema obliga al usuario a cambiarla en el primer
        ingreso.
      & Alta & Admin \\
\hline
...
RF-23 & Dashboard
      & El dashboard debe mostrar la lista de todos los experimentos del laboratorio
        ...
        y accesos directos a resultados y descarga (ver RN-08).
      & Alta & Investigador \\
\hline
RF-24 & Dashboard
...
entre 1.5 y 2~h; con más de 32~videos por semestre, el sistema elimina más de
200~horas-persona de trabajo manual por ciclo. Al no requerir compra de hardware
