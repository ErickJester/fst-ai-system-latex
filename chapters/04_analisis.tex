...
RN-11 & La detección de cilindros requiere una confianza mínima de 0.70. Si no se
        ...
        provisional definido a partir de las pruebas preliminares de detección
        realizadas con los videos del laboratorio (véase la
        sección~\ref{sec:fact_tecnologica}); no se deriva directamente de
        \cite{stadler2024_yolov8}, cuyo contexto de validación corresponde a
        detección de objetos en general y no a la detección específica de
        cilindros en el FST. Este valor se ajustará con base en los videos reales
        durante la fase de validación y robustez (TT2).
