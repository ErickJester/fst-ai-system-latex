...
En este capítulo se definen los requerimientos del sistema a partir de las seis pantallas
del protocolo experimental del
laboratorio colaborador y de reuniones con el Dr.\ César Augusto Sandino Reyes López,
investigador del Laboratorio de Neurociencia Conductual de la ENMyH-IPN. Se documentan
...
Para respaldar esta factibilidad, se realizarán reuniones con el Dr.\ Sandino en las
que se aplicará un instrumento de recolección de datos ---una entrevista estructurada
...
Los resultados de esa entrevista se incorporarán a este documento antes de la entrega
final y se incluirá el instrumento completo en los anexos.
...
contribuye a resultados más reproducibles, lo que tiene impacto directo en la calidad
de la investigación \cite{armario2021}.
